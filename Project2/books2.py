...
class BookRequest(BaseModel):
    ...
    published_date: int = Field(gt=1000, lt=2031)
...
BOOKS = [
    Book(1, "Computer Sience Pro", "codingwithroby", "A very nice book!", 5, 2023),
...
async def read_book_by_published_date(published_date: int = Query(gt=1000, lt=2031)):
    books_to_return = []
    for book in BOOKS:
